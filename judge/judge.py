...
class Judge(nn.Module):
    ...
    def train_model(self, data_file, criterion, optimizer, scheduler=None, num_epochs=100, batch_size=2, test=False, wandb_plot=True):  
        ...
        dataset = TapTapDataset(data_file)
